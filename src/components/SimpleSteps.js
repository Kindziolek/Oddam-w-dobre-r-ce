...
const SimpleSteps = () => {
  return (
    <div id="SimpleSteps" className={styles.simpleSteps}>
      ...
      <div className={styles.simpleSteps__container}>
        <div className={styles.simpleSteps__container_content}>
          ...
          <div className={styles.simpleSteps__box}>
            ...
            <p className={styles.simpleSteps__box_text}>
              kurier przyjedzie
              <br></br>w dogodnym terminie
            </p>
          </div>
        </div>
      </div>
      <div className={styles.simpleSteps__container__link}>
        <Link
          to="/logowanie"
          className={styles.simpleSteps__container__link_box}
        >
          ODDAJ
          <br></br>
          RZECZY
